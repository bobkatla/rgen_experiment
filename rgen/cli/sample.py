...
@click.command(help="Sample images from an EMA diffusion checkpoint (DDIM, optional CFG).")
...
def sample(ckpt, out_dir, n_samples, batch_size, steps, guidance, guidance_weight, class_balance, seed, classes_json):
